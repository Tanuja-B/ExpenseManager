...
public class ExpenseActivity extends AppCompatActivity {
    ...
    private Button buttonSave,cancelBtn;
    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private FirebaseRecyclerAdapter<Model, ExpenseViewHolder> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editAmount = findViewById(R.id.amt_exp);
        editType = findViewById(R.id.type_exp);
        editNote = findViewById(R.id.note_exp);
        buttonSave = findViewById(R.id.save_exp);
        cancelBtn=findViewById(R.id.cancel_exp);
        ...
        loadExpenseData(); // Load the expense data using FirebaseRecyclerAdapter
    }
    ...
    private void addExpense() {
        ...
        if (!amount.isEmpty() && !type.isEmpty()) {
            DatabaseReference newExpenseRef = mExpenseDatabase.push();
            String id = newExpenseRef.getKey(); // Get the unique ID generated by Firebase
    ...
    private void loadExpenseData() {
        ...
        adapter = new FirebaseRecyclerAdapter<Model, ExpenseViewHolder>(options) {
            ...
            public ExpenseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = getLayoutInflater().inflate(R.layout.expense_recycler_data, parent, false);
                return new ExpenseViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(ExpenseViewHolder holder, @SuppressLint("RecyclerView") int position, Model model) {
                ...
                // Set an onClick listener for each item if needed
    ...
    private void showOptionsForItem(final String itemID) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ExpenseActivity.this); // Use IncomeActivity.this as the context
    ...
    private void deleteItem(String itemID) {
        ...
        DatabaseReference itemRef = mExpenseDatabase.child(itemID);
        itemRef.removeValue();
                    ...
                    builder.setTitle("Edit Item")
                            .setPositiveButton("Update", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    Toast.makeText(ExpenseActivity.this, "Item edited successfully", Toast.LENGTH_SHORT).show();
                                }
                            })
