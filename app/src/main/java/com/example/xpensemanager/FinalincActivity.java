...
public class FinalincActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(FinalincActivity.this,HomeActivity.class);
                startActivity(i);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(FinalincActivity.this,tax1Activity.class);
                startActivity(i);
            }
        });
